...
print("• Sensor read energy consumption [mJ]: ", sensor_total_energy_consumption)
print("• Transmission energy consumption [mJ]: ", transmission_energy_consumption)
print("• Boot up and working chip consumption [mJ]:", boot_up_energy_consumption)
print("\n")
...
total_duty_cycle_sec= personal_duty_cycle + total_working_time
